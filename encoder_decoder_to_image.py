...
def image_generator(counter, images, testset):
    ...
    with torch.no_grad():
        ...
        plt.savefig(os.getcwd() + '/results_images/images_previous/image'+str(counter)+'.jpg')
        ...
        plt.savefig(os.getcwd()+'/results_images/images_after/image'+str(counter)+'.jpg')
